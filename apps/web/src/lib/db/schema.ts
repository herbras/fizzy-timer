...
export const MOOD_INFO: Record<MoodType, { icon: string; name: string; color: string; description: string }> = {
  fire: { icon: 'solar:fire-bold', name: 'Fire Mode', color: 'bg-orange-500/20', description: 'We are fine!' },
  chill: { icon: 'solar:chillin-bold', name: 'Chill Mode', color: 'bg-blue-500/20', description: 'Stay relaxed' },
  focus: { icon: 'solar:brain-bold', name: 'Focus Mode', color: 'bg-purple-500/20', description: 'Deep work' },
  chaos: { icon: 'solar:tornado-bold', name: 'Chaos Mode', color: 'bg-pink-500/20', description: 'Spinning!' },
  determined: { icon: 'solar:handshake-bold', name: 'Determined', color: 'bg-amber-500/20', description: "Let's go!" },
};
