...
export function BoardCard({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "flex-shrink-0 px-5 py-2.5 rounded-2xl text-sm font-bold transition-all",
        "border-2 min-w-fit max-w-[180px]",
        isActive
          ? "shadow-lg"
...
export function BoardCardList({
  ...
  return (
    <div
      className={cn(
        "flex gap-2 overflow-x-auto p-2 scrollbar-hide snap-x snap-mandatory",
        className,
      )}
    >
      {showAll && (
